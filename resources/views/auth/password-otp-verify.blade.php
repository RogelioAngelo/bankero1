                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('password.otp.verify.post') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', session('email')) }}" required autofocus>
                        ...
                        {{-- token is handled server-side; do not display to user --}}

                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('Verify OTP and continue') }}
                                </button>
                            </div>
                        </div>
                    </form>
